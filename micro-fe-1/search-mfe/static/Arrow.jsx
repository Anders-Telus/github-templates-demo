    ...
    <g id='Welcome' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
      <g id='Select-result-Walker---MOB' transform='translate(-3.000000, -151.000000)'>
        <g id='arrow-icon' transform='translate(3.000000, 151.000000)'>
          <g>
            <rect id='Rectangle-Copy-2' fill='#4B286D' x='0' y='0' width='36' height='36' />
            <g
            ...
            >
              ...
              <use id='ArrowDown' fill='#4B286D' fillRule='evenodd' xlinkHref='#arrow' />
              <g id='bg/icon/inverted' mask='url(#mask-2)' fill='#FFFFFF' fillRule='evenodd'>
