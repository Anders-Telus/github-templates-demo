...
const icon = (
  <svg width='32px' height='32px' viewBox='0 0 24 24' version='1.1' xmlns='http://www.w3.org/2000/svg' xlink='http://www.w3.org/1999/xlink'>
    <title>_casa / icons / timeline / cases</title>
    <desc>Created with Sketch.</desc>
    <defs>
      <path d='M20,24 L4,24 C1.8,24 0,22.2 0,20 L0,4 C0,1.8 1.8,0 4,0 L20,0 C22.2,0 24,1.8 24,4 L24,20 C24,22.2 22.2,24 20,24' id='case-purple' />
    </defs>
    <g id='Customer-story' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
      <g id='23-when-due-date-for-task-exceeds-date' transform='translate(-971.000000, -290.000000)'>
        <g id='_casa-/-icons-/-timeline-/-cases' transform='translate(971.000000, 290.000000)'>
          <g id='cases'>
            <g id='bg/icon/default'>
              <mask id='mask-2' fill='white'>
                <use xlinkHref='#case-purple' />
              </mask>
              <use id='Mask' fill='#231F20' xlinkHref='#case-purple' />
              <g id='_TDScore/bg/icon/secondary' mask='url(#mask-2)' fill='#4B286D'>
...
const CasePurple = (props) => {
  return React.createElement(CasaIcon, props, icon)
}
export default CasePurple
