        ...
        <g id='arrow-icon' transform='translate(3.000000, 151.000000)'>
          <g>
            ...
            >
              ...
              <use id='ArrowDown' fill='#F7F7F8' fillRule='evenodd' xlinkHref='#path-1' />
              <g id='bg/icon/inverted' mask='url(#mask-1)' fill='#71757B' fillRule='evenodd'>
