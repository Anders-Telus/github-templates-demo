...
const TaskGrey = (props) => {
  ...
  return React.createElement(CasaIcon, props, (
    <svg width='24px' height='24px' viewBox='0 0 24 24' version='1.1' xmlns='http://www.w3.org/2000/svg'>
      ...
      <defs>
        <path d='M20,24 L4,24 C1.8,24 0,22.2 0,20 L0,4 C0,1.8 1.8,0 4,0 L20,0 C22.2,0 24,1.8 24,4 L24,20 C24,22.2 22.2,24 20,24' id='task-grey' />
      </defs>
      <g id='Account' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='Icons' transform='translate(-313.000000, -242.000000)'>
          <g id='Group-3' transform='translate(313.000000, 242.000000)'>
            <g id='_casa-/-icons-/-timeline-/-cases-copy'>
              <g id='cases'>
                <g id='bg/icon/default'>
                  <mask id='mask-2' fill='white'>
                    <use xlinkHref='#task-grey' />
                  </mask>
                  <use id='Mask' fill='#231F20' xlinkHref='#task-grey' />
            ...
            <g id='Group-2-Copy' transform='translate(5.000000, 1.000000)'>
